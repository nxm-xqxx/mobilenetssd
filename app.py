...
lineaccesstoken = 'N4M/ULgrPvmymHH9br8bzonhvV0qKQKpOG3WxvW7dgPdCcbmfCqv9lJAT35w6BmA4BYg44VOvKdL4ohLwuuuVg04utCHVGWDgINCKWbsThyQ5U8oTgqe4OqZcwWz73GbKj+OeaYo873RAKyEZNwXVgdB04t89/1O/w1cDnyilFU='
...
def event_handle(event,json_line):
    ...
    if msgType == "text":
        ...
        if (msg == "สวัสดี") :
            ...
            replyObj = TextSendMessage(text="คุยกับเทอไง")
            line_bot_api.reply_message(rtoken, replyObj)
        elif (msg == "เป็นน่ารัก") :
            replyObj = TextSendMessage(text="อะแน่นอน")
            line_bot_api.reply_message(rtoken, replyObj)
        elif (msg == "จ๊าบปะหล่ะ") :
            ...
            url = "https://dialogflow.cloud.google.com/v1/integrations/line/webhook/1f691406-2461-4735-bb1b-bd30f928f256"
